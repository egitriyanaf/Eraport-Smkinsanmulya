                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcome-heading">
                                    <form role="search" class="sr-input-func" method="GET"
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($User as $key => $user)
                                                    <tr>
                                                        <th class=" text-center" scope="row">{{ $User->firstItem() + $key }}
                                                        </th>
                                                        <td class=" text-center" scope="row">{{ $user->email }}</td>
                                                        <td class=" text-center" scope="row">{{ $user->role }}</td>
                                                        <td class=" text-center" scope="row">
                                                            {{ $user->getKodeIdPersonil($user->id, $user->role, $user->id_personil) }}
                                                        </td>

                                                        <td scope="row" class=" text-center">
                                                            <a href="{{ url('/edituser/' . $user->id) }}"><button
                                                            ...
                                                            <form action="{{ url('/deleteuser/' . $user->id) }}"
                                                                ...
                                                                onsubmit="return confirm('Apakah yakin data ini ingin di hapus?')">
                                                                @method('delete')
                                                                @csrf
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/tambahuser') }}" class="needs-validation" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Id User</label>
                                    <input type="text" name="Id" class="form-control" autofocus
                                        value="{{ $user->getuserIDplus() }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email" id="email" class="form-control" maxlength="30"
                                        autofocus required placeholder="Masukkan Email">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control" maxlength="30"
                                        autofocus required placeholder="Masukkan Password">
